...
- Freelance AI engineer, I mainly worked for [PyannoteAI](https://www.pyannote.ai/)
- I'm one of the major contributors to [`pyannote.audio`](https://github.com/pyannote/pyannote-audio), the most widely used python DNN-based toolkit for answering "who spoke when" question, and on [`gryannote`](https://github.com/clement-pages/gryannote), an open source audio labeling tool.
- I'm the founder of [Heleyna](https://heleyna.fr), a weather dashboard.
- I have founded [sunbot](https://github.com/skyeye-weather/sunbot), a discord bot providing current and forecast weathe.

## Papers I contributed to

All the papers I contributed to are available on [Google Scholar](https://scholar.google.fr/citations?user=MhN7op8AAAAJ&hl=fr). Here are some of them:
